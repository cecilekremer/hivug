  ...
  with(as.list(c(state,parameters)),
       {
         ...
         list(c(dS1f1,dH1f1,dY1f1,dZ1f1,dA1f1,
              ...
              Stot=Stot,Htot=Htot,Ytot=Ytot,Ztot=Ztot,Atot=Atot,NItot=NItot,
              NIf1=NIf1, NIf2=NIf2, NIf3=NIf3, NIm1=NIm1, NIm2=NIm2, NIm3=NIm3)
       }
  )
}
...
RP_f1 = (0.1677699 - trial1_FM[721,"PRf1"]) / 0.1677699
RP_f2 = (0.27897 - trial1_FM[721,"PRf2"]) / 0.27897
RP_f3 = (0.2985279 - trial1_FM[721,"PRf3"]) / 0.2985279
RP_m1 = (0.1087947 - trial1_FM[721,"PRm1"]) / 0.1087947
RP_m2 = (0.1566935 - trial1_FM[721,"PRm2"]) / 0.1566935
RP_m3 = (0.09532198 - trial1_FM[721,"PRm3"]) / 0.09532198
RP_tot = (0.1413861 - trial1_FM[721,"PRtot"]) / 0.1413861

# Relative reduction in incidence
RI_f1 = (1.821743 - trial1_FM[721,"IRf1"]) / 1.821743
RI_f2 = (3.24038 - trial1_FM[721,"IRf2"]) / 3.24038
RI_f3 = (3.464507 - trial1_FM[721,"IRf3"]) / 3.464507
RI_m1 = (1.174148 - trial1_FM[721,"IRm1"]) / 1.174148
RI_m2 = (1.697399 - trial1_FM[721,"IRm2"]) / 1.697399
RI_m3 = (0.9631866 - trial1_FM[721,"IRm3"]) / 0.9631866
RI_tot = (1.86785 - trial1_FM[721,"IRtot"]) / 1.86785

# Relative reduction in AIDS-related mortality
RA_f1 = (1.107056 - trial1_FM[721,"AMf1"]) / 1.107056
RA_f2 = (1.851648 - trial1_FM[721,"AMf2"]) / 1.851648
RA_f3 = (1.985516 - trial1_FM[721,"AMf3"]) / 1.985516
RA_m1 = (0.7767919 - trial1_FM[721,"AMm1"]) / 0.7767919 
RA_m2 = (1.125126 - trial1_FM[721,"AMm2"]) / 1.125126
RA_m3 = (0.684069 - trial1_FM[721,"AMm3"]) / 0.684069
RA_tot = (0.9669307 - trial1_FM[721,"AMtot"]) / 0.9669307

# Reduction in total number of infections
RNI_tot = (702.4755 - sum(trial1_FM[721, c("Htot","Ytot","Ztot","Atot")])) / 702.4755

# Reduction in number of NEW infections
RNInew_tot = (988.6189 - sum(trial1_FM[541:721, "NItot"])) / 988.6189
RNInew_f1 = (489.6397 - sum(trial1_FM[541:721, "NIf1"])) / 489.6397
RNInew_f2 = (20.55168 - sum(trial1_FM[541:721, "NIf2"])) / 20.55168
RNInew_f3 = (44.90587 - sum(trial1_FM[541:721, "NIf3"])) / 44.90587
RNInew_m1 = (300.9546 - sum(trial1_FM[541:721, "NIm1"])) / 300.9546
RNInew_m2 = (64.73702 - sum(trial1_FM[541:721, "NIm2"])) / 64.73702
RNInew_m3 = (67.83004 - sum(trial1_FM[541:721, "NIm3"])) / 67.83004
...
write.table(out,file=paste0("intervention_sim_", sim, ".csv"),append=F,col.names=FALSE,row.names=FALSE,sep=",")
